//@ sourceMappingURL=validation_error_codes.map
// Generated by CoffeeScript 1.6.1
var ValidationErrorCodes;

ValidationErrorCodes = (function() {

  function ValidationErrorCodes() {}

  ValidationErrorCodes.Address = {
    CannotBeBlank: "81801",
  ...
  ValidationErrorCodes.ApplePayCard = {
  ...
  ValidationErrorCodes.AuthorizationFingerprint = {
  ...
  ValidationErrorCodes.ClientToken = {
  ...
  ValidationErrorCodes.Descriptor = {
  ...
  ValidationErrorCodes.MerchantAccount = {
    ApplicantDetails: {
  ...
  ValidationErrorCodes.PaymentMethod = {
  ...
  ValidationErrorCodes.PayPalAccount = {
    AuthExpired: "92911",
  ...
  ValidationErrorCodes.SEPABankAccount = {
    IBANIsRequired: "93001",
    BICIsRequired: "93002",
    AccountHolderNameIsRequired: "93003"
  };

  ValidationErrorCodes.SEPAMandate = {
